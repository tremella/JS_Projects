...
router.post('/admin/products/:id/edit',
    ...
    upload.single('image'),
    [requireTitle,
    requirePrice], //validators
    handleErrors(productsEditTemplate, async req => {
        const product = await productsRepo.getOne(req.params.id);
        return { product }; //async is an optional function to do if 'require' validation steps failed
        // async takes in request object, looks up a product and returns it inside an object
        // this will tell us about the product which failed the validation checks
    }),
    async (req, res) => {
        ...
        // if everything goes well for the update statement, redirect
